 ...
 */
package com.agorapulse.micronaut.amazon.awssdk.itest.localstack.v1.dynamodb;
...
import com.agorapulse.micronaut.aws.dynamodb.DynamoDBFactory;
...
@Singleton
@Requires(classes = DynamoDBFactory.class, beans = LocalstackContainerHolder.class)
