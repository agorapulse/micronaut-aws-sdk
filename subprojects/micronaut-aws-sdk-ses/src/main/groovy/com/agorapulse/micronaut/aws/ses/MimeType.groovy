...
class MimeType {
    ...
    static List<MimeType> allMimeTypes() {
        return ALL.collect { new MimeType(suffixApplicable: it[0], mediaTypeSubtype: it[1]) }
    }
