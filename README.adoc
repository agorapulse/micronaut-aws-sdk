...
--
image::https://api.bintray.com/packages/agorapulse/libs/micronaut-librariesimages/download.svg[link="https://bintray.com/agorapulse/libs/micronaut-libraries/_latestVersion",float="left"]
