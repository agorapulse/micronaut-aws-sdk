...
cannot be found the official https://docs.micronaut.io/latest/guide/index.html#springBeans[Spring support for Micronaut]:
...
<4> The name of the Spring bean defaults to the _property name_ of the class, e.g. `widget`
