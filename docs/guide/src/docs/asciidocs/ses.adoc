...
.Groovy
----
include::../subprojects/micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/ses/SendEmailSpec.groovy[]
----
...
.Java
----
include::../subprojects/micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/ses/SendEmailTest.java[]
----
<1> Start building an email
<2> Define subject of the email
<3> Define the from address
