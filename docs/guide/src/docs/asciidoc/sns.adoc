...
.Gradle (AWS SDK 2.x)
----
compile 'com.agorapulse:micronaut-amazon-awssdk-sns:{project-version}'
----
...
For AWS SDK 2.x, use packages starting `com.agorapulse.micronaut.amazon.awsskd.sns`.

For AWS SDK 1.x, use packages starting `com.agorapulse.micronaut.aws.skd.sns`.
...
.Groovy (AWS SDK 2.x)
----
include::{root-dir}/subprojects/micronaut-amazon-awssdk-sns/src/test/groovy/com/agorapulse/micronaut/amazon/awssdk/sns/SimpleNotificationServiceSpec.groovy[tags=testcontainers-header]

include::{root-dir}/subprojects/micronaut-amazon-awssdk-sns/src/test/groovy/com/agorapulse/micronaut/amazon/awssdk/sns/SimpleNotificationServiceSpec.groovy[tags=testcontainers-fields]

include::{root-dir}/subprojects/micronaut-amazon-awssdk-sns/src/test/groovy/com/agorapulse/micronaut/amazon/awssdk/sns/SimpleNotificationServiceSpec.groovy[tags=testcontainers-setup]

        context = ApplicationContext.build('aws.sns.topic', TEST_TOPIC).build()         // <5>
include::{root-dir}/subprojects/micronaut-amazon-awssdk-sns/src/test/groovy/com/agorapulse/micronaut/amazon/awssdk/sns/SimpleNotificationServiceSpec.groovy[tags=testcontainers-setup-2]
...
include::{root-dir}/subprojects/micronaut-amazon-awssdk-sns/src/test/groovy/com/agorapulse/micronaut/amazon/awssdk/sns/SimpleNotificationServiceTest.java[tags=testcontainers-setup]
