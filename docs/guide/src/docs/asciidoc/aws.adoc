...
NOTE: For AWS SDK 2.x use artefacts starting with `micronaut-amazon-awssdk`. These artefacts are written pure Java, and they should be GraalVM Native Image friendly.
