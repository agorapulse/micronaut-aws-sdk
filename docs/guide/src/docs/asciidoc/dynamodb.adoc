...
.Kotlin
----
include::{root-dir}/kotlin-libs/micronaut-amazon-awssdk-dynamodb-kotlin/src/test/kotlin/com/agorapulse/micronaut/amazon/awssdk/dynamodb/kotlin/DynamoDBEntity.kt[lines=19..-1]
----
<1> The entity must be annotated with `@Introspected` or `@DynamoDBBean`
<2> The entity must provide the partition key using `@ParitionKey` annotation
<3> The sort key is optional
...
NOTE: Alternative: use `@DynamoDbImmutable` that is mapped to `@Introspected` annotation using the DynamoDB annotation processor.
...
NOTE: Use packages starting `com.agorapulse.micronaut.amazon.awssdk.dynamodb`.
...
----
include::{root-dir}/kotlin-libs/micronaut-amazon-awssdk-dynamodb-kotlin/src/test/kotlin/com/agorapulse/micronaut/amazon/awssdk/dynamodb/kotlin/DynamoDBEntityService.kt[tags=header]

include::{root-dir}/kotlin-libs/micronaut-amazon-awssdk-dynamodb-kotlin/src/test/kotlin/com/agorapulse/micronaut/amazon/awssdk/dynamodb/kotlin/DynamoDBEntityService.kt[tags=sample-query-class]

include::{root-dir}/kotlin-libs/micronaut-amazon-awssdk-dynamodb-kotlin/src/test/kotlin/com/agorapulse/micronaut/amazon/awssdk/dynamodb/kotlin/DynamoDBEntityService.kt[tags=sample-query]
...
include::{root-dir}/kotlin-libs/micronaut-amazon-awssdk-dynamodb-kotlin/src/test/kotlin/com/agorapulse/micronaut/amazon/awssdk/dynamodb/kotlin/DynamoDBEntityService.kt[tags=sample-scan-class]

include::{root-dir}/kotlin-libs/micronaut-amazon-awssdk-dynamodb-kotlin/src/test/kotlin/com/agorapulse/micronaut/amazon/awssdk/dynamodb/kotlin/DynamoDBEntityService.kt[tags=sample-scan]
...
include::{root-dir}/kotlin-libs/micronaut-amazon-awssdk-dynamodb-kotlin/src/test/kotlin/com/agorapulse/micronaut/amazon/awssdk/dynamodb/kotlin/DynamoDBEntityService.kt[tags=sample-update-class]

include::{root-dir}/kotlin-libs/micronaut-amazon-awssdk-dynamodb-kotlin/src/test/kotlin/com/agorapulse/micronaut/amazon/awssdk/dynamodb/kotlin/DynamoDBEntityService.kt[tags=sample-update]
...
Please see https://agorapulse.github.io/micronaut-amazon-awssdk/api/com/agorapulse/micronaut/amazon/awssdk/dynamodb/DynamoDBService.html[DynamoDBService] for full reference.
...
----
include::{root-dir}/subprojects/micronaut-amazon-awssdk-dynamodb-loader/src/test/java/com/agorapulse/amazon/awssdk/dynamodb/loader/DynamoDbLoaderTest.java[tags=loader]
----
...
<7> Alternatively you can  load the data without saving them to the DynamoDB using the `read` methods
