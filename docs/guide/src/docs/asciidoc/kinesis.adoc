...
For AWS SDK 2.x, use packages starting `com.agorapulse.micronaut.amazon.awsskd.kinesis`.

For AWS SDK 1.x, use packages starting `com.agorapulse.micronaut.aws.skd.kinesis`.
...
.Groovy (AWS SDK 2.x)
----
include::{root-dir}/subprojects/micronaut-amazon-awssdk-kinesis/src/test/groovy/com/agorapulse/micronaut/amazon/awssdk/kinesis/KinesisServiceSpec.groovy[tags=testcontainers-header]
include::{root-dir}/subprojects/micronaut-amazon-awssdk-kinesis/src/test/groovy/com/agorapulse/micronaut/amazon/awssdk/kinesis/KinesisServiceSpec.groovy[tags=testcontainers-setup]

include::{root-dir}/subprojects/micronaut-amazon-awssdk-kinesis/src/test/groovy/com/agorapulse/micronaut/amazon/awssdk/kinesis/KinesisServiceSpec.groovy[tags=testcontainers-test]
