...
By default, `QueueClient` publishes recoreds into the default queue defined by `aws.sqs.queue` property.
...
.Creating Queue
----
include::{root-dir}/subprojects/micronaut-aws-sdk-sqs/src/test/groovy/com/agorapulse/micronaut/aws/sqs/SimpleQueueServiceTest.java[tags=new-queue]
----
...
.Delete Queue
----
include::{root-dir}/subprojects/micronaut-aws-sdk-sqs/src/test/groovy/com/agorapulse/micronaut/aws/sqs/SimpleQueueServiceTest.java[tags=delete-queue]
----
<1> Delete queue
...
Please, see https://agorapulse.github.io/micronaut-aws-sdk/api/com/agorapulse/micronaut/aws/sqs/SimpleQueueService.html[SimpleQueueService] for the full reference.
