...
----
<1> You can specify the default connections URL for https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/MessageSender.html[MessageSender]
<2> If you are creating Java functions don't forget to specify the function's name for deployments

NOTE: https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/MessageSender.html[MessageSender] bean
is only present in the context if `aws.websocket.connectins.url` configuration property is present.Use https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/MessageSenderFactory.html[MessageSenderFactory]
If you want to create https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/MessageSender.html[MessageSender]
...
You can use https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/WebSocketConnectionRequest.html[WebSocketConnectionRequest]
as an argument to function handling connection and disconnection of the WebSocket and https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/WebSocketRequest.html[WebSocketRequest] for handling
incoming messages.
...
<3> https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/WebSocketRequest.html[WebSocketRequest] can handle any incoming event
<4> Create https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/MessageSender.html[MessageSender] for current client
...
If you want to publish to the WebSockets using https://agorapulse.github.io/micronaut-libraries/api/com/agorapulse/micronaut/aws/apigateway/ws/MessageSender.html[MessageSender]
