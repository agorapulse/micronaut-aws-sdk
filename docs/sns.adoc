...
This library provides two approaches to work with Simple Notification Service queues:

1. High-level <<Publishing with `@NotificationClient`>>
2. Middle-level <<Simple Notification Service>>

==== Configuration
No configuration is required but some of the configuration propertis may be useful for you.

[source,yaml,indent=0,options="nowrap"]
.application.yml
----
include::../micronaut-aws-sdk/src/test/resources/application-docs-sns.yml[]
----
...
----
include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/DefaultClient.java[]
----
...
by setting the `topic` property of the annotation such as `@NotificationClient(topic = "SomeTopic")`. You can change stream
...
.Creating Topic
----
include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceTest.java[tags=new-topic]
----
...
.Subscribe to Topic
----
include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceTest.java[tags=subscription]
----
...
.Delete Topic
----
include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceTest.java[tags=delete-topic]
----
<1> Delete the topic
...
.Working with Applications
----
include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceTest.java[tags=applications]
----
...
.Sending SMS
----
include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceTest.java[tags=sms]
----
...
.Groovy
----
include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceSpec.groovy[tags=testcontainers-header]

include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceSpec.groovy[tags=testcontainers-fields]

include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceSpec.groovy[tags=testcontainers-setup]
...
include::../micronaut-aws-sdk/src/test/groovy/com/agorapulse/micronaut/aws/sns/SimpleNotificationServiceTest.java[tags=testcontainers-setup]
